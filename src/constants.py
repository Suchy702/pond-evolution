...
# AI
CHANCE_TO_SMART_FISH_DO_RANDOM_MOVE: float = 0.05
CHANCE_THAT_FISH_GO_TO_BOTTOM_FOR_FOOD: float = 0.65
CHANCE_THAT_FISH_GO_FOR_FOOD: float = 0.80
CHANCE_THAT_FISH_NOT_RUN: float = 0.10
CNT_FISH_DIV: int = 20
